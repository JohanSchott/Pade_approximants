*> \brief \b ilazlcquad scans a matrix for its last non-zero column.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download ilazlcquad + dependencies 
...
*  ===========
*
*       INTEGER FUNCTION ilazlcquad( M, N, A, LDA )
* 
*       .. Scalar Arguments ..
*       INTEGER            M, N, LDA
*       ..
...
*> \verbatim
*>
*> ilazlcquad scans A for its last non-zero column.
*> \endverbatim
*
*  Arguments:
*  ==========
...
*     Now scan each column from the end, returning with the first non-zero.
         DO ilazlcquad = N, 1, -1
            DO I = 1, M
               IF( A(I, ilazlcquad).NE.ZERO ) RETURN
            END DO
         END DO
      END IF
      RETURN
