*> \brief \b zlacgvquad conjugates a complex vector.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download zlacgvquad + dependencies 
...
*  ===========
*
*       SUBROUTINE zlacgvquad( N, X, INCX )
* 
*       .. Scalar Arguments ..
*       INTEGER            INCX, N
*       ..
...
*> \verbatim
*>
*> zlacgvquad conjugates a complex vector of length N.
*> \endverbatim
*
*  Arguments:
*  ==========
