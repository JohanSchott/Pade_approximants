*> \brief \b zlangequad returns the value of the 1-norm, Frobenius norm, infinity-norm, or the largest absolute value of any element of a general rectangular matrix.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download zlangequad + dependencies 
...
*  ===========
*
*       real*16 FUNCTION zlangequad( NORM, M, N, A, LDA, WORK )
* 
*       .. Scalar Arguments ..
*       CHARACTER          NORM
*       INTEGER            LDA, M, N
...
*> \verbatim
*>
*> zlangequad  returns the value of the one norm,  or the Frobenius norm, or
...
*> \verbatim
*>
*>    zlangequad = ( max(abs(A(i,j))), NORM = 'M' or 'm'
*>             (
...
*> \verbatim
*>          NORM is CHARACTER*1
*>          Specifies the value to be returned in zlangequad as described
*>          above.
*> \endverbatim
*>
*> \param[in] M
...
*
   ...
   70    CONTINUE
         ...
         DO 80 I = 1, M
            ...
            IF( VALUE.LT.TEMP .OR. disnanquad( TEMP ) ) VALUE = TEMP
   80    CONTINUE
      ELSE IF( ( lsamequad( NORM, 'F' ) ) .OR. ( lsamequad( NORM, 'E'  
     $      ) ) ) THEN 
*
*        Find normF(A).
*
         ...
         SUM = ONE
         DO 90 J = 1, N
            CALL zlassqquad( M, A( 1, J ), 1, SCALE, SUM )
   90    CONTINUE
