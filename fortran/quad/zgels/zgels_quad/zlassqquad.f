*> \brief \b zlassqquad updates a sum of squares represented in scaled form.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download zlassqquad + dependencies 
...
*  ===========
*
*       SUBROUTINE zlassqquad( N, X, INCX, SCALE, SUMSQ )
* 
*       .. Scalar Arguments ..
*       INTEGER            INCX, N
*       real*16   SCALE, SUMSQ
...
*> \verbatim
*>
*> zlassqquad returns the values scl and ssq such that
*>
...
*
      IF( N.GT.0 ) THEN
         DO 10 IX = 1, 1 + ( N-1 )*INCX, INCX
            TEMP1 = ABS( real( X( IX ) ) )
            IF( TEMP1.GT.ZERO.OR.disnanquad( TEMP1 ) ) THEN
