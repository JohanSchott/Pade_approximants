...
*
*> \htmlonly
*> Download xerblaquad + dependencies 
...
*  ===========
*
*       SUBROUTINE xerblaquad( SRNAME, INFO )
* 
*       .. Scalar Arguments ..
*       CHARACTER*(*)      SRNAME
*       INTEGER            INFO
...
*> \verbatim
*>
*> xerblaquad  is an error handler for the LAPACK routines.
...
*> \verbatim
*>          SRNAME is CHARACTER*(*)
*>          The name of the routine which called xerblaquad.
*> \endverbatim
*>
*> \param[in] INFO
*> \verbatim
