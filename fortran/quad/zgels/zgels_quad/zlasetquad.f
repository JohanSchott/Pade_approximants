*> \brief \b zlasetquad initializes the off-diagonal elements and the diagonal elements of a matrix to given values.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download zlasetquad + dependencies 
...
*  ===========
*
*       SUBROUTINE zlasetquad( UPLO, M, N, ALPHA, BETA, A, LDA )
* 
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
*       INTEGER            LDA, M, N
...
*> \verbatim
*>
*> zlasetquad initializes a 2-D array A to BETA on the diagonal and
